...
%  We denote the gradient of $F^{\ell',\ell}$ by $\mathcal D F^{\ell',\ell}$.
  ...
  \begin{align*}
    ...
    &= \sum_{\fin\in\mathcal H^{\text{in}}} \sum_m 2 [(\nabla^\ell F)(V,\fin)^{\mathtt t}]_{nm} (F_m(V,\fin) - [F_\infty]_m)
    ,
  \end{align*}
  ...
  \begin{proposition}
    ...
    \begin{equation}
      ...
      \begin{aligned}
        ...
        \mathbf J^{\ell-1} &= \prod_{\ell'=L}^{\ell} \mathtt D\Phi^{\ell'}(x^{\ell'-1})  = \mathbf J^{\ell} \, w^{\ell} D\Phi^{\ell}(x^{\ell-1}), \quad \mathbf J^L =\id, \\
